resource "aws_iam_role" "user_processor_role" {
  name = "${var.project_name}-user-processor-role"
...
resource "aws_iam_role" "replicator_role" {
  name = "${var.project_name}-replicator-role"
...
resource "aws_iam_role_policy" "user_processor_policy" {
  name = "${var.project_name}-user-processor-policy"
...
resource "aws_iam_role_policy" "replicator_policy" {
  name = "${var.project_name}-replicator-policy"
  role = aws_iam_role.replicator_role.id
